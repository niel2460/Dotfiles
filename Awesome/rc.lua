...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "WWW", "DEV", "DOC", "VOBX", "CHAT", "MUS", "VID", "GFX", "SYS" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
   ...
   awful.key({}, "XF86AudioStop", function()
    ...
    --screenshots
    awful.key({ }, "Print", function () awful.util.spawn("scrot -e 'mv $f ~/Imágenes/screenshots 2>/dev/null'", false) end,
    	      {description = "Sceenshot save in /Images/Screenshots", group = "hotkeys"}),      
